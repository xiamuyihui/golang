...
*/
	public IniFileReader(String conf_filename) throws FileNotFoundException, IOException
	{
		...
		loadPropertisFile(conf_filename);
	}
...
*/
	...
	private void loadPropertisFile(String conf_filename) throws FileNotFoundException, IOException
	{
		BufferedReader buffReader;
		String line;
		String[] parts;
		...
		ArrayList valueList;
		this.paramTable = new Hashtable();
		InputStream inCfg = getClass().getClassLoader().getResourceAsStream(conf_filename);	 
		InputStreamReader inputReader=new InputStreamReader(inCfg);
