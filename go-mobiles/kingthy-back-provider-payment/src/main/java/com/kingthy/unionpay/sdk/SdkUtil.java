...
import static com.kingthy.unionpay.sdk.SdkConstants.*;
...
public class SdkUtil
{
    ...
    public static boolean sign(Map<String, String> data, String encoding)
    {
        ...
        String signMethod = data.get(PARAM_SIGN_METHOD);
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("signMethod must Not null");
            return false;
        }
        
        if (isEmpty(version))
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("version must Not null");
            return false;
        }
        if (SIGNMETHOD_RSA.equals(signMethod) || VERSION_1_0_0.equals(version) || VERSION_5_0_1.equals(version))
        {
            ...
            {
                // 设置签名证书序列号
                data.put(SdkConstants.PARAM_CERT_ID,
                    com.kingthy.unionpay.sdk.CertUtil.getSignCertId());
                // 将Map信息转换成key1=value1&key2=value2的形式
                String stringData = coverMap2String(data);
                com.kingthy.unionpay.sdk.LogUtil.writeLog("待签名请求报文串:[" + stringData + "]");
                byte[] byteSign = null;
                String stringSign = null;
                try
                {
                    // 通过SHA1进行摘要并转16进制
                    byte[] signDigest = com.kingthy.unionpay.sdk.SecureUtil.sha1X16(stringData, encoding);
                    byteSign = com.kingthy.unionpay.sdk.SecureUtil.base64Encode(com.kingthy.unionpay.sdk.SecureUtil
                        .signBySoft(com.kingthy.unionpay.sdk.CertUtil.getSignCertPrivateKey(), signDigest));
                ...
                {
                    com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("Sign Error", e);
                    return false;
                }
            }
            else if (VERSION_5_1_0.equals(version))
            {
                ...
                {
                    // 通过SHA256进行摘要并转16进制
                    byte[] signDigest = com.kingthy.unionpay.sdk.SecureUtil.sha256X16(stringData, encoding);
                    byteSign = com.kingthy.unionpay.sdk.SecureUtil.base64Encode(com.kingthy.unionpay.sdk.SecureUtil
                        .signBySoft256(com.kingthy.unionpay.sdk.CertUtil.getSignCertPrivateKey(), signDigest));
                    stringSign = new String(byteSign);
                    // 设置签名域值
                    data.put(SdkConstants.PARAM_SIGNATURE, stringSign);
                    return true;
    ...
    public static boolean signBySecureKey(Map<String, String> data, String secureKey, String encoding)
    {
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("secureKey is empty");
            return false;
        }
        String signMethod = data.get(PARAM_SIGN_METHOD);
        ...
        if (SIGNMETHOD_SHA256.equals(signMethod))
        {
            ...
            String stringData = coverMap2String(data);
            com.kingthy.unionpay.sdk.LogUtil.writeLog("待签名请求报文串:[" + stringData + "]");
            String strBeforeSha256 = stringData + SdkConstants.AMPERSAND
                + com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(secureKey, encoding);
            String strAfterSha256 = com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(strBeforeSha256, encoding);
            // 设置签名域值
        ...
        else if (SIGNMETHOD_SM3.equals(signMethod))
        {
            ...
            String strBeforeSM3 = stringData + SdkConstants.AMPERSAND
                + com.kingthy.unionpay.sdk.SecureUtil.sm3X16Str(secureKey, encoding);
            String strAfterSM3 = com.kingthy.unionpay.sdk.SecureUtil.sm3X16Str(strBeforeSM3, encoding);
            // 设置签名域值
    ...
    public static boolean signByCertInfo(Map<String, String> data, String certPath, String certPwd, String encoding)
    {
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("CertPath or CertPwd is empty");
            return false;
        }
        String signMethod = data.get(PARAM_SIGN_METHOD);
        String version = data.get(SdkConstants.PARAM_VERSION);
        ...
        if (SIGNMETHOD_RSA.equals(signMethod) || VERSION_1_0_0.equals(version) || VERSION_5_0_1.equals(version))
        {
            if (VERSION_5_0_0.equals(version) || VERSION_1_0_0.equals(version) || VERSION_5_0_1.equals(version))
            {
                // 设置签名证书序列号
                data.put(SdkConstants.PARAM_CERT_ID,
                    com.kingthy.unionpay.sdk.CertUtil.getCertIdByKeyStoreMap(certPath, certPwd));
                // 将Map信息转换成key1=value1&key2=value2的形式
                String stringData = coverMap2String(data);
                com.kingthy.unionpay.sdk.LogUtil.writeLog("待签名请求报文串:[" + stringData + "]");
                byte[] byteSign = null;
                ...
                try
                {
                    ...
                    byte[] signDigest = com.kingthy.unionpay.sdk.SecureUtil.sha1X16(stringData, encoding);
                    byteSign =
                        com.kingthy.unionpay.sdk.SecureUtil.base64Encode(com.kingthy.unionpay.sdk.SecureUtil.signBySoft(
                            com.kingthy.unionpay.sdk.CertUtil.getSignCertPrivateKeyByStoreMap(certPath, certPwd),
                            signDigest));
                    stringSign = new String(byteSign);
                    // 设置签名域值
                    data.put(SdkConstants.PARAM_SIGNATURE, stringSign);
            ...
            else if (VERSION_5_1_0.equals(version))
            {
                ...
                try
                {
                    // 通过SHA256进行摘要并转16进制
                    byte[] signDigest = com.kingthy.unionpay.sdk.SecureUtil.sha256X16(stringData, encoding);
                    byteSign = com.kingthy.unionpay.sdk.SecureUtil
                        .base64Encode(com.kingthy.unionpay.sdk.SecureUtil.signBySoft256(
                            com.kingthy.unionpay.sdk.CertUtil.getSignCertPrivateKeyByStoreMap(certPath, certPwd),
                            signDigest));
                    stringSign = new String(byteSign);
                    // 设置签名域值
    ...
    {
        com.kingthy.unionpay.sdk.LogUtil.writeLog("验签处理开始");
        if (isEmpty(encoding))
        {
            encoding = "UTF-8";
        }
        ...
        if (SIGNMETHOD_SHA256.equals(signMethod))
        {
            ...
            com.kingthy.unionpay.sdk.LogUtil.writeLog("签名原文：[" + stringSign + "]");
            // 将Map信息转换成key1=value1&key2=value2的形式
            String stringData = coverMap2String(resData);
            com.kingthy.unionpay.sdk.LogUtil.writeLog("待验签返回报文串：[" + stringData + "]");
            String strBeforeSha256 = stringData + SdkConstants.AMPERSAND
                + com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(secureKey, encoding);
            String strAfterSha256 = com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(strBeforeSha256, encoding);
    ...
    public static boolean validate(Map<String, String> resData, String encoding)
    {
        ...
        if (SIGNMETHOD_RSA.equals(signMethod) || VERSION_1_0_0.equals(version) || VERSION_5_0_1.equals(version))
        {
            ...
            if (VERSION_5_0_0.equals(version) || VERSION_1_0_0.equals(version) || VERSION_5_0_1.equals(version))
            {
                ...
                com.kingthy.unionpay.sdk.LogUtil.writeLog("对返回报文串验签使用的验签公钥序列号：[" + certId + "]");
                // 将Map信息转换成key1=value1&key2=value2的形式
                String stringData = coverMap2String(resData);
                com.kingthy.unionpay.sdk.LogUtil.writeLog("待验签返回报文串：[" + stringData + "]");
                try
                {
                    // 验证签名需要用银联发给商户的公钥证书.
                    return com.kingthy.unionpay.sdk.SecureUtil.validateSignBySoft(
                        com.kingthy.unionpay.sdk.CertUtil.getValidatePublicKey(certId),
                        com.kingthy.unionpay.sdk.SecureUtil.base64Decode(stringSign.getBytes(encoding)),
                        com.kingthy.unionpay.sdk.SecureUtil.sha1X16(stringData, encoding));
                }
                catch (UnsupportedEncodingException e)
                {
                    com.kingthy.unionpay.sdk.LogUtil.writeErrorLog(e.getMessage(), e);
                }
                catch (Exception e)
                {
                    com.kingthy.unionpay.sdk.LogUtil.writeErrorLog(e.getMessage(), e);
            ...
            else if (VERSION_5_1_0.equals(version))
            {
                ...
                X509Certificate x509Cert = com.kingthy.unionpay.sdk.CertUtil.genCertificateByStr(strCert);
                if (x509Cert == null)
                {
                    com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("convert signPubKeyCert failed");
                    return false;
                }
                // 2.验证证书链
                if (!com.kingthy.unionpay.sdk.CertUtil.verifyCertificate(x509Cert))
                {
                    com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("验证公钥证书失败，证书信息：[" + strCert + "]");
                    return false;
                }
                ...
                {
                    // 验证签名需要用银联发给商户的公钥证书.
                    boolean result = com.kingthy.unionpay.sdk.SecureUtil.validateSignBySoft256(x509Cert.getPublicKey(),
                        com.kingthy.unionpay.sdk.SecureUtil.base64Decode(stringSign.getBytes(encoding)),
                        com.kingthy.unionpay.sdk.SecureUtil.sha256X16(stringData, encoding));
                    com.kingthy.unionpay.sdk.LogUtil.writeLog("验证签名" + (result ? "成功" : "失败"));
                    return result;
                }
                catch (UnsupportedEncodingException e)
                {
        ...
        else if (SIGNMETHOD_SHA256.equals(signMethod))
        {
            ...
            com.kingthy.unionpay.sdk.LogUtil.writeLog("待验签返回报文串：[" + stringData + "]");
            String strBeforeSha256 = stringData + SdkConstants.AMPERSAND
                + com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(SdkConfig.getConfig().getSecureKey(), encoding);
            String strAfterSha256 = com.kingthy.unionpay.sdk.SecureUtil.sha256X16Str(strBeforeSha256, encoding);
        ...
        else if (SIGNMETHOD_SM3.equals(signMethod))
        {
            ...
            com.kingthy.unionpay.sdk.LogUtil.writeLog("待验签返回报文串：[" + stringData + "]");
            String strBeforeSM3 = stringData + SdkConstants.AMPERSAND
                + com.kingthy.unionpay.sdk.SecureUtil.sm3X16Str(SdkConfig.getConfig().getSecureKey(), encoding);
            String strAfterSM3 = com.kingthy.unionpay.sdk.SecureUtil.sm3X16Str(strBeforeSM3, encoding);
    ...
    {
        String strCert = resData.get(SdkConstants.PARAM_ENCRYPT_PUB_KEY_CERT);
        String certType = resData.get(SdkConstants.PARAM_CERT_TYPE);
        ...
        {
            // 更新敏感信息加密公钥
            if (!com.kingthy.unionpay.sdk.CertUtil.getEncryptCertId().equals(x509Cert.getSerialNumber().toString()))
            {
                // ID不同时进行本地证书更新操作
                ...
                com.kingthy.unionpay.sdk.LogUtil.writeLog("save new encryptPubKeyCert success");
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeLog("unknown cerType:" + certType);
            return -1;
        }
    }
    ...
    public static boolean copyFile(String srcFile, String destFile)
    {
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("CopyFile fail", e);
        }
        finally
        {
            try
            ...
            {
                com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("Releases any system resources fail", ex);
            }
        }
        return flag;
    }
    ...
    public static boolean writeFile(String filePath, String fileContent, String encoding)
    {
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("WriteFile fail", e);
            return false;
        }
        catch (IOException ex)
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog("WriteFile fail", ex);
            return false;
        }
        finally
        {
    ...
    public static byte[] readFileByNIO(String filePath)
    {
        ...
        {
            com.kingthy.unionpay.sdk.LogUtil.writeErrorLog(e.getMessage());
            return null;
        }
        finally
        {
    ...
    {
        com.kingthy.unionpay.sdk.LogUtil.writeLog("打印请求报文域 :");
        Map<String, String> submitFromData = new HashMap<>(1);
     ...
     * @throws IOException
     */
    public static byte[] deflater(final byte[] inputByte)
        throws IOException
    {
        int compressedDataLength = 0;
